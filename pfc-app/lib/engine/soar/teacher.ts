 ...
 *
 * In LLM mode, this calls the model to produce structured curriculum.
 * In simulation mode, it generates template-based stepping stones.
 */
...
function generateSimulatedCurriculum(
  ...
  return {
    ...
    generationTimeMs: Date.now() - startTime,
    iteration,
    teacherRationale: `[Simulation] Generated ${numStones} template stepping stones for ${domain}/${questionType} domain targeting progressive skill building.`,
  };
}
