  ...
  switch (mode) {
    ...
    case 'simulation':
      return {
        ...
        supportsLogprobs: false,
        supportsWeightUpdates: false,
        estimatedCostPerIteration: 'Free (synthetic)',
        estimatedLatencyPerIteration: '<1s (simulated delays)',
        learningPersistence: 'none',
        limitations: [
          'Simulation mode generates template-based responses — no actual reasoning occurs',
          'SOAR loop demonstrates the framework but cannot produce real insight',
          'Reward signals are synthetic — they show the measurement system, not real improvement',
          'Useful for understanding the SOAR flow and testing UI, not for actual analysis',
        ],
        advantages: [
          'Instant feedback for testing and demonstration',
          'No API keys or local models required',
          'Shows the full SOAR pipeline flow without cost',
        ],
      };
  }
}
