import type { SynthesisReport, DualMessage } from './types';
import type { ChatMessage, PFCState } from '../store/usePFCStore';

export function generateSynthesisReport(
  messages: ChatMessage[],
  storeSnapshot: Pick<PFCState,
...
function generatePlainSummary(
  ...
  sysMsgs: ChatMessage[],
  snap: Pick<PFCState, 'confidence' | 'safetyState' | 'queriesProcessed' | 'skillGapsDetected'>,
): string {
...
function generateSuggestions(
  sysMsgs: ChatMessage[],
  snap: Pick<PFCState, 'confidence' | 'entropy' | 'dissonance' | 'safetyState' | 'skillGapsDetected' | 'tda'>,
): string[] {
