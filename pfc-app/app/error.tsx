...
/**
 * Root-level error boundary for all page routes.
 * This catches rendering errors in any page component
 * and displays a user-friendly fallback UI.
 *
 * Next.js automatically wraps each route segment in a
 * React Error Boundary when an error.tsx file is present.
 */
export default function RootError({
  ...
  useEffect(() => {
    console.error('[RootError] Uncaught error in page route:', error);
  }, [error]);
