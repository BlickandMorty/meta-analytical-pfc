...
function AuthorCard({ author, isDark }: { author: ExtractedAuthor; isDark: boolean }) {
  ...
  return (
    <div className={cn(
      ...
      <div
        ...
        style={{
          background: isDark ? 'rgba(139,124,246,0.15)' : 'rgba(139,124,246,0.1)',
          color: '#8B7CF6',
        }}
      >
...
function ResearchToolsTab({ isDark }: { isDark: boolean }) {
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6">
        <StatCard label="Papers" value={researchPapers.length} icon={FileTextIcon} color="#8B7CF6" />
        <StatCard label="Authors" value={totalAuthors} icon={UsersIcon} color="#22D3EE" />
        <StatCard label="Citations" value={totalCitations} icon={QuoteIcon} color="#F59E0B" />
        <StatCard label="Topics" value={allTags.length} icon={TagIcon} color="#34D399" />
      </div>
      ...
      <AnimatePresence mode="wait">
        ...
        >
                ...
                <>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                    {filteredAuthors.map((author) => (
                      <AuthorCard key={author.name} author={author} isDark={isDark} />
                    ))}
                  </div>
                </>
              )}
          ...
          {/* Research Tools tab */}
          {activeTab === 'tools' && (
            <ResearchToolsTab isDark={isDark} />
          )}
        </motion.div>
      </AnimatePresence>
    </PageShell>
