 ...
 * user-controllable steering settings. The prompt-composer translates these
 * into behavioral LLM directives, and the analytical stages use structured
 * prompt templates (see lib/engine/prompts/) encoding mathematical frameworks
 * like Bradford Hill criteria, Cohen's d, and Bayesian updating.
 */
