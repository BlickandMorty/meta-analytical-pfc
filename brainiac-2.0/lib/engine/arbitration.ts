...
/**
 * Template-based arbitration (fallback keyword heuristic).
 *
 * Provides a deterministic fallback for multi-engine arbitration.
 * Scans stage result text for predefined keyword patterns to derive
 * engine "voting" on conclusions.
 *
 ...
 * text strings without understanding what they mean. The LLM performs genuine
 * multi-perspective analysis via `llmGenerateArbitration()`.
 */
