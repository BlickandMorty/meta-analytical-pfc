...
//
// When an LLM model is available, the model scores contradiction
// likelihood for each pair. Otherwise, heuristic keyword/negation
// analysis provides an approximation.
// ═══════════════════════════════════════════════════════════════════
